...
/**
 * Listeners class implements TestNG's ITestListener interface to listen to test events.
 * It provides methods to log test events and capture screenshots upon test failure.
 */

@Slf4j
public class Listeners extends BrowserUtils implements ITestListener, IAnnotationTransformer {
