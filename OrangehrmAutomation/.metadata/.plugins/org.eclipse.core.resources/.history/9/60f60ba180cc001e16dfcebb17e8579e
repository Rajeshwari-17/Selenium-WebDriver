...
//		driver.manage().timeouts().pageLoadTimeout(10, TimeUnit.SECONDS);
	...
	private static void addJobTitles(WebDriver driver)
	{
		 try {
	            ...
	            for (int i = 0; i < sheet.getLastRowNum(); i++) {
	                ...
	                WebElement addButton = driver.findElement(By.className("oxd-icon"));
	                addButton.click();

	                WebElement jobTitleField = driver.findElement(By.className("oxd-input"));
	                jobTitleField.sendKeys(jobTitle);

	                WebElement saveButton = driver.findElement(By.className("oxd-button"));
	                saveButton.click();
	            }
